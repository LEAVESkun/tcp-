...
if __name__ == "__main__":
    main()
"""enter this
python client.py --size-mb 50 --trials 5 --buf-kb 64 --streams 1



python client.py --size-mb 10  --trials 5 --buf-kb 64 --streams 1

python client.py --size-mb 50  --trials 5 --buf-kb 64 --streams 1

python client.py --size-mb 200 --trials 5 --buf-kb 64 --streams 1



python client.py --size-mb 50 --trials 5 --buf-kb 4  --streams 1

python client.py --size-mb 50 --trials 5 --buf-kb 16 --streams 1
...
python client.py --size-mb 200 --trials 5 --buf-kb 64 --streams 1
python client.py --size-mb 200 --trials 5 --buf-kb 64 --streams 2
python client.py --size-mb 200 --trials 5 --buf-kb 64 --streams 4
"""